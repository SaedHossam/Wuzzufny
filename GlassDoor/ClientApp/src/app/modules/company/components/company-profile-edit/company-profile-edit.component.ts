  ...
  ngOnInit(): void {
    ...
    this.displayProfileService.getCompanyProfileEdit().subscribe((data) => {
      ...
      this.editProfileForm.get('aboutUs').setValue(this.companyProfile.aboutUs);
        ...
        this.editProfileForm.get('facebookLink').setValue(this.companyLinks.find(l=>l.name == "facebook").link);
        this.editProfileForm.get('linkedinLink').setValue(this.companyLinks.find(l=>l.name == "linkedin").link);
